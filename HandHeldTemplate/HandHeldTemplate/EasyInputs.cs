namespace easyInputs
{
    ...
    public static class EasyInputs
    {
        ...
        /// <summary>
        /// Get's If The Menu Button Is Pressed.
        /// </summary>
        public static bool GetMenuButtonDown(EasyHand easyHand)
        {
            GetInputBool(easyHand, CommonUsages.menuButton, out bool ButtonDown);
            return ButtonDown;
        }
